    ...
    <div class="col-12">
      <div class="card card-outline card-success">
        <div class="card-header">
          <h4 class="card-title"> <i class="fa fa-sign-in-alt text-success"></i> &ensp; Daftar Pengiriman Barang</h4>
          <div class="card-tools">
            <a href="{{ route('pengiriman-barang.create') }}" class="btn btn-xs btn-success px-3">
          ...
          <table class="table table-bordered">
            <thead>
              <tr>
                ...
                <th class="align-middle p-2 text-center" width="15%">Tanggal Pengiriman</th>
                <th class="align-middle p-2 text-center" width="15%">Lokasi Asal</th>
            ...
            <tbody>
              @forelse ($dataPermintaan as $item)
                <tr>
                  ...
                  <td class="align-middle p-2 text-center">
                    <div class="btn-group">
                      <a href="{{ route('pengiriman-barang.detail', $item->id) }}" class="btn btn-info btn-sm px-3">
