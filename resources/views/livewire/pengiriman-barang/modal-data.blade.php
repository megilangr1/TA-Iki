<div>
  <div wire:ignore.self class="modal fade" id="modal-data-pengiriman">
          ...
          <table class="table table-bordered mb-0">
            <thead>
              <tr>
                ...
                <th class="align-middle px-3 py-2 text-center" width="15%">Tanggal Pengiriman</th>
                <th class="align-middle px-3 py-2" width="20%">Pengiriman Dari</th>
            ...
            <tbody>
              @forelse ($dataPengiriman as $item)
                <tr>
                  ...
                  <td class="align-middle px-3 py-1 text-center">{{ $item->tanggal_pengiriman != null ? date('d/m/Y', strtotime($item->tanggal_pengiriman)) : '-' }}</td>
                  ...
                  <td class="align-middle px-3 py-1" wire:click="selectPengirimanBarang('{{ $item->id }}')">
...
<script>
  $(document).ready(function () {
    Livewire.on('modal-data-pengiriman', function(showProps) {
      $('#modal-data-pengiriman').modal(showProps);
    });
  });
</script>
@endpush